  ...
  return (
    <div className={styles.sidebar}>
      ...
      <ul className={styles.list}>
        <li
          className={`${styles.profilelist} ${styles.profile}`}
        ...
        {isArrowDownServiceVisible && (
          <ul className={styles.moreDownservice}>
            ...
            <li
              ...
              onClick={() => handleItemClick("oneoff")}
            >
              One-Off
            </li>
        ...
        <li
          ...
          className={`${styles.profilelist} ${styles.book} `}
        >
          <svg
            width='24'
            height='24'
      ...
      {isArrowDownVisible && (
        <ul className={styles.moreDown}>
          ...
          <li className={styles.downlist}>Financials</li>
          <li className={styles.downlist}>Contacts</li>
          <li className={styles.downlist}>Support</li>
        </ul>
      )}
    </div>
  );
