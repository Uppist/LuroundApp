      ...
      <div className={styles.settingsdetail}>
        ...
        {data.service_type === "event" && (
          <div className={styles.settingscontainer}>
            ...
            >
              <path
                d='M11.9999 9.49966C11.667 9.49213 11.3359 9.55119 11.0261 9.67338C10.7163 9.79556 10.4341 9.9784 10.1959 10.2112C9.95776 10.4439 9.76852 10.7219 9.63929 11.0288C9.51006 11.3358 9.44344 11.6654 9.44336 11.9984C9.44328 12.3314 9.50972 12.6611 9.6388 12.9681C9.76788 13.275 9.95699 13.5531 10.195 13.786C10.4331 14.0189 10.7152 14.2019 11.0249 14.3242C11.3347 14.4465 11.6657 14.5058 11.9986 14.4984C12.6518 14.484 13.2734 14.2144 13.7303 13.7474C14.1873 13.2803 14.4432 12.653 14.4434 11.9996C14.4435 11.3463 14.1879 10.7188 13.7312 10.2516C13.2745 9.78433 12.6531 9.51443 11.9999 9.49966Z'
                fill='currentColor'
                fill-opacity='0.8'
              />
              <path
                d='M12 7.625C15.91 7.625 18.4025 10.0525 19.7725 12C18.4025 13.9475 15.91 16.375 12 16.375C8.09 16.375 5.5975 13.9475 4.2275 12C5.5975 10.0525 8.09 7.625 12 7.625ZM12 5.75C7.5125 5.75 4.0975 8.41625 2 12C4.0975 15.5837 7.5125 18.25 12 18.25C16.4875 18.25 19.9025 15.5837 22 12C19.9025 8.41625 16.4862 5.75 12 5.75Z'
                fill='currentColor'
                fill-opacity='0.8'
              />
            </svg>
