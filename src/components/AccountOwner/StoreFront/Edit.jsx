...
import Delete from "../Services/QuickAction/Delete";
        ...
        <div className={styles.quickaction}>
          ...
          {insight && (
            <div className='popupcancel popupwithdrawpin'>
              ...
              <Insight Close={() => setInsight(false)} data={data} />
            </div>
          )}
          <div className={`${styles.settingscontainer} ${styles.suspend}`}>
            <div className={styles.suspenddiv}>
              ...
              <span>
                {" "}
                {isSuspended ? "Unsuspend Product" : "Suspend Product"}
              </span>
            </div>
            <div className={styles.togglebutton}>
              <input
                ...
                checked={isSuspended}
              />
              <label htmlFor='check' className={styles.toggle}></label>
            </div>
          </div>
          ...
          {share && (
            <div className='popupcancel popupwithdrawpin'>
              <div className='overlay' onClick={() => setIsQr(false)}></div>
              <Share Close={() => setShare(false)} data={data} />
            </div>
          )}
          <div onClick={shareQr}>
            <svg
          ...
          {isDelete && (
            <div className='popupcancel popupwithdrawpin'>
              <div className='overlay' onClick={() => setIsDelete(false)}></div>
              <Delete data={data} Close={() => setIsDelete(false)} />
            </div>
          )}
        </div>
      </div>
