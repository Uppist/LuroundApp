...
export default function PopUp({ CancelAddProduct, handleClick }) {
  ...
  return (
    <div className={styles.contactline}>
      ...
      {/* <div className='overlay' onClick={CancelAddProduct}></div> */}
      ...
      <div className={styles.contactinfo}>
        ...
        <div className={styles.contactdetails}>
          ...
          <input placeholder="Owner's name" type='text' />
        </div>
        <div className={styles.contactdetails}>
        ...
        <div className={styles.contactdetails}>
          ...
          <div className={styles.dropdown}>
            ...
            >
              <label> {selectedOption || "ebook"}</label>
            </div>
            {isOpen && (
          ...
          <div className={styles.openbox}>
            ...
            {isExternal && (
              <div className={styles.redirect}>
                ...
                <input type='text' placeholder='https://redirecturl.com' />
              </div>
            )}
          </div>
        </div>
