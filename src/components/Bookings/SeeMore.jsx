                    ...
                    <div className='appointmentdetails'>
                      <div className='appointment'>
                        ...
                        <div className='appointmentdate'>
                          ...
                          <span className='dateam'> {booking.time}</span>
                        </div>
                      </div>
                      ...
                      <div className='appointment'>
                        <div className='appointmentdate'>
                          ...
                          <span className='date'>{booking.hour}</span>
                        </div>
                        <div className='appointmentdate'>
                          <span className='date'> Time Zone </span>
                          <span className='dateam'>
                      ...
                      <div className='appointment'>
                        <div className='appointmentdate'>
                          ...
                          <span className='date'>Virtual</span>
                        </div>
                        <div className='appointmentdate'>
                      ...
                      <div className='appointment'>
                        <div className='appointmentdate'>
                          ...
                          <span className='date'> 35,000 </span>
                        </div>
                        <div className='appointmentdate'>
          ...
          {showReschedule ? (
            <div>
              <div className='reschedulebooking'>
                <div className='linereschedule'>
                  <div className='reschedulebook' onClick={backReschedule}>
                    <svg
                      width='7'
                      height='12'
                      viewBox='0 0 7 12'
                ...
                <Calendar booking={booking} ChangeBack={ChangeBack} />
              </div>
            </div>
          ) : onCancel ? (
            <CancelN onClose={closeModal} booking={booking} />
          ) : (
            <div className='reschedulecontent'>
              ...
              <div className='reschedule-cancel'>
                <div className='rescheduletext' onClick={Reschedule}>
                  <svg
                    width='24'
                    height='24'
                    viewBox='0 0 24 24'
