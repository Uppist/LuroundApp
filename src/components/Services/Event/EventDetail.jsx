            ...
            <div className='moredetails-container'>
              <div className='content-type'>
                <div className='personal-service'>
                  <span className='personal'>{dataevent.Title}</span>
                  <div className='service-one'>
                    <span className='servicetype'>{dataevent.servicetype}</span>
                    <span className='oneofftext'>{dataevent.oneoff}</span>
                  </div>
                </div>
              </div>
            ...
            <div className='quickaction-container'>
              ...
              <div className='settings-detail'>
                ...
                <div className='settings-container' onClick={DeleteOneoff}>
                  ...
                  <span>Delete</span>
                  {isDelete && (
                    <Delete dataevent={dataevent} backdelete={Back} />
                  )}
                </div>
              </div>
            </div>
