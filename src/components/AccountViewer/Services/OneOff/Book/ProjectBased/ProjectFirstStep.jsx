...
import styles from "../TimeBased/StepOne/style.module.css";
import Details from "../TimeBased/StepThree/Details";

export default function ProjectFirstStep() {
  ...
  const isNext = Object.values(information).every((val) => val.trim() !== "");
  ...
  //   navigate("/bookingdetails", { state: { information } });
  // }
        ...
        <div className={styles.project}>
          ...
          <div className={styles.projectBased}>
            ...
            <div className={styles.button}>
              ...
              <button className={styles.next} disabled={!isNext} onClick={Next}>
                Next
              </button>
            </div>
          </div>
