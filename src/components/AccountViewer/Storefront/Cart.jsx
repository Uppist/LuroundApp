...
const Cart = ({
  ...
  const handleQuantityChange = (index, change) => {
    ...
    newItems[index].quantity = Math.max(
      1,
      (newItems[index].quantity || 1) + change
    );
    setItems(newItems);
  };
          ...
          <div className={styles.cartContent}>
            ...
            <div className={styles.contactInformation}>
              ...
              <div className={styles.phoneInputGroup}>
                ...
                >
                  <option className={styles.formInfo} value='+234'>
                    (+234) Nigeria
                  </option>
                  <option className={styles.formInfo} value='+1'>
                    (+1) United States{" "}
                  </option>
                  <option className={styles.formInfo} value='+44'>
                    (+44) United Kingdom
                  </option>
                  <option className={styles.formInfo} value='+91'>
                    (+91) India
                  </option>
                  <option className={styles.formInfo} value='+81'>
                    (+81) Japan
                  </option>
                  <option className={styles.formInfo} value='+86'>
                    (+86) China
                  </option>
                  <option className={styles.formInfo} value='+33'>
                    (+33) France
                  </option>
                  <option className={styles.formInfo} value='+49'>
                    (+49) Germany
                  </option>
                  <option className={styles.formInfo} value='+7'>
                    (+7) Russia
                  </option>
                  <option className={styles.formInfo} value='+55'>
                    (+55) Brazil
                  </option>
                </select>
                <input
              ...
              <p className={styles.termsText}>
                By clicking the "Checkout" button, you agree to Luroond's{" "}
                <button className={styles.termsButton}>
                  Terms & Conditions
                </button>
              </p>
        ...
        <div className={styles.deleteModal}>
          <div className={styles.deleteModalContent}>
            ...
            <div className={styles.buttonGroupss}>
              <button
                className={styles.deleteCancelButtonModal}
                onClick={() => setShowDeleteModal(false)}
              >
                Cancel
              </button>
              <button
                className={styles.deleteConfirmButtonModal}
